    ...
    constructor(app: App) {
        ...
        [
            [
                'search',
                'search',
                (i: string): SidebarItem => {
                    return new SidebarSearch(app, i);
                },
            ],
            [
                'layers',
                'layers',
                (_id: string): SidebarItem => {
                    return self.sidebar_layers;
                },
            ],
            [
                'markers',
                ...
                (id: string): SidebarItem => {
                    return new SidebarMarkers(app, id);
                },
            ],
            [
                'lines',
                'maximize-2',
                (id: string): SidebarItem => {
                    return new SidebarLines(app, id);
                },
            ],
            [
                'tools',
                'tool',
                (id: string): SidebarItem => {
                    return new SidebarTools(app, id);
                },
            ],
            [
                'info',
